## kobuki_desktop (kinetic) - 0.5.7-0

The packages in the `kobuki_desktop` repository were released into the `kinetic` distro by running `/usr/bin/bloom-release --track kinetic --rosdistro kinetic kobuki_desktop` on `Mon, 15 May 2017 00:06:56 -0000`
...
## kobuki_desktop (kinetic) - 0.5.6-0

The packages in the `kobuki_desktop` repository were released into the `kinetic` distro by running `/usr/bin/bloom-release --track kinetic --rosdistro kinetic kobuki_desktop` on `Sat, 01 Apr 2017 19:48:24 -0000`
...
## kobuki_desktop (kinetic) - 0.5.5-0

The packages in the `kobuki_desktop` repository were released into the `kinetic` distro by running `/usr/bin/bloom-release --track kinetic --rosdistro kinetic kobuki_desktop` on `Wed, 29 Mar 2017 04:59:21 -0000`
...
## kobuki_desktop (kinetic) - 0.5.0-0

The packages in the `kobuki_desktop` repository were released into the `kinetic` distro by running `/usr/bin/bloom-release --track kinetic --rosdistro kinetic kobuki_desktop` on `Wed, 10 Aug 2016 22:02:42 -0000`
...
## kobuki_desktop (kinetic) - 0.4.2-0

The packages in the `kobuki_desktop` repository were released into the `kinetic` distro by running `/usr/bin/bloom-release --track kinetic --rosdistro kinetic kobuki_desktop` on `Wed, 10 Aug 2016 21:55:51 -0000`
...
## kobuki_desktop (indigo) - 0.4.2-0

The packages in the `kobuki_desktop` repository were released into the `indigo` distro by running `/usr/bin/bloom-release kobuki_desktop -t indigo -r indigo` on `Mon, 02 Mar 2015 08:45:46 -0000`
